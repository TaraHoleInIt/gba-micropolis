...
#include "mcgasheet_img_bin.h"
#include "mcgasheet_pal_bin.h"
...
void MCGAWorldRenderer::init( void ) {
    ...
    dmaCopy( mcgasheet_pal_bin, SPRITE_PALETTE, mcgasheet_pal_bin_size );
    dmaCopy( mcgasheet_img_bin, SPR_VRAM( 0 ), mcgasheet_img_bin_size );
}

void MCGAWorldRenderer::deinit( void ) {
}

IWRAM_CODE void MCGAWorldRenderer::update( unsigned short* simMap[ WORLD_W ] ) {
